      ...
      <div class="row margin-t-30">
        <div class="col-lg-4">
          <div class="blog-box margin-t-30">
            <img src="@/assets/images/img-1.jpg" class="img-fluid rounded" alt />
            <div>
        ...
        <div class="col-lg-4">
          <div class="blog-box margin-t-30">
            <img src="@/assets/images/img-2.jpg" class="img-fluid rounded" alt />
            <div>
        ...
        <div class="col-lg-4">
          <div class="blog-box margin-t-30">
            <img src="@/assets/images/img-3.jpg" class="img-fluid rounded" alt />
            <div>
