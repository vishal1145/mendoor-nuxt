      ...
      <div class="row margin-t-50">
          ...
          <div class="team-box text-center">
            <div class="team-wrapper">
              <div class="team-member">
                <img alt src="@/assets/images/img-1.jpg" class="img-fluid rounded" />
              </div>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="team-box text-center">
            <div class="team-wrapper">
              <div class="team-member">
                <img alt src="@/assets/images/img-2.jpg" class="img-fluid rounded" />
              </div>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="team-box text-center">
            <div class="team-wrapper">
              <div class="team-member">
                <img alt src="@/assets/images/img-3.jpg" class="img-fluid rounded" />
              </div>
            </div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="team-box text-center">
            <div class="team-wrapper">
              <div class="team-member">
                <img alt src="@/assets/images/img-4.jpg" class="img-fluid rounded" />
              </div>
            </div>
